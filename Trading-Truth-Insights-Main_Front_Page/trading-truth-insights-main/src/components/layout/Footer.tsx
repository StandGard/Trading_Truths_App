      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl">Trading Truth</span>
            </Link>
            <p className="mt-4 text-sm text-muted-foreground">
              The platform for traders who value transparency, accountability and continuous improvement.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t text-center md:flex md:items-center md:justify-between">
          <div className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Trading Truth. All rights reserved.
          </div>
